...
export const skills = [
  {
    title: "Languages",
    skills: [
      { name: "JavaScript", image: "icons/skills/languages/js.svg" },
      { name: "TypeScript", image: "icons/skills/languages/ts.svg" },
      { name: "Java", image: "icons/skills/languages/java.svg" },
      { name: "C++", image: "icons/skills/languages/cpp.svg" },
      { name: "Bash", image: "icons/skills/languages/bash.svg" },
      { name: "PowerShell", image: "icons/skills/languages/powershell.svg" }
    ]
  },
  {
    title: "Frontend",
    skills: [
      { name: "React", image: "icons/skills/frontend/react.svg" },
      { name: "Angular", image: "icons/skills/frontend/angular.svg" },
      { name: "HTML", image: "icons/skills/frontend/html.svg" },
      { name: "CSS", image: "icons/skills/frontend/css.svg" },
      { name: "TailwindCSS", image: "icons/skills/frontend/tailwind-css.svg" },
      { name: "Bootstrap", image: "icons/skills/frontend/bootstrap.svg" }
    ]
  },
  {
    title: "Backend",
    skills: [
      { name: "Node.js", image: "icons/skills/backend/nodejs.svg" },
      { name: "Express.js", image: "icons/skills/backend/expressjs.svg" },
      { name: "Spring Boot", image: "icons/skills/backend/spring-boot.svg" },
      { name: "Spring Security", image: "icons/skills/backend/spring-security.svg" },
      { name: "Keycloak", image: "icons/skills/backend/keycloak.svg" }
    ]
  },
  {
    title: "Databases & Cloud",
    skills: [
      { name: "PostgreSQL", image: "icons/skills/db-cloud/postgresql.svg" },
      { name: "MySQL", image: "icons/skills/db-cloud/mysql.svg" },
      { name: "MongoDB", image: "icons/skills/db-cloud/mongodb.svg" },
      { name: "Firebase", image: "icons/skills/db-cloud/firebase.svg" },
      { name: "AWS", image: "icons/skills/db-cloud/aws.svg" }
    ]
  },
  {
    title: "Mobile Development",
    skills: [
      { name: "React Native", image: "icons/skills/mobile/react-native.svg" }
    ]
  },
  {
    title: "CyberSecurity",
    skills: [
      { name: "Nmap", image: "icons/skills/cybersec/nmap.svg" },
      { name: "BurpSuite", image: "icons/skills/cybersec/burp-suite.svg" },
      { name: "WireShark", image: "icons/skills/cybersec/wireshark.svg" },
      { name: "Shodan", image: "icons/skills/cybersec/shodan.svg" },
      { name: "FoxyProxy", image: "icons/skills/cybersec/foxy-proxy.png" },
      { name: "Kali Linux", image: "icons/skills/cybersec/kali-linux.svg" },
      { name: "Cryptography", image: "icons/skills/cybersec/cryptography.svg" }
    ]
  },
  {
  ...
  },
  {
    title: "Tools & DevOps",
    skills: [
      { name: "Git", image: "icons/skills/devops/git.svg" },
      { name: "GitLab", image: "icons/skills/devops/gitlab.svg" },
      { name: "GitHub", image: "icons/skills/devops/github.svg" },
      { name: "Maven", image: "icons/skills/devops/maven.svg" },
      { name: "Postman", image: "icons/skills/devops/postman.svg" },
      { name: "VS Code", image: "icons/skills/devops/visual-studio-code.svg" }
    ]
  }
];
